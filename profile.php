  ...
  switch ($_GET['view']) {
    case '':
      ...
      if ($system['mibikisi_enabled']) {
        $profile['mibikisi'] = $user->get_mibikisi(array('user_id' => $profile['user_id'], 'results' => $system['min_results_even']));
      }
    ...
    case 'mibikisi':
      ...
      /* get mibikisi */
      $profile['mibikisi'] = $user->get_mibikisi(array('user_id' => $profile['user_id']));
      break;
