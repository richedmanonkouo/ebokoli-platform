        ...
        <div class="col-lg-4 js_sticky-sidebar">
          ...
          {if $new_mibikisi}
            <div class="card">
              <div class="card-header bg-transparent">
                <div class="float-end">
                  <small><a href="{$system['system_url']}/mibikisi">{__("See All")}</a></small>
                </div>
                {__("Suggested Mibikisi")}
              </div>
              <div class="card-body with-list">
                <ul>
                  {foreach $new_mibikisi as $_group}
                    {include file='__feeds_mobikisi.tpl' _tpl="list"}
                  {/foreach}
                </ul>
              </div>
            </div>
