                    ...
                    <div class="navbar-wrapper">
                      <ul>
                        {if $user->_logged_in}
                          ...
                          {if $user->_data['can_add_stories'] || $user->_data['can_write_articles'] || $user->_data['can_sell_products'] || $user->_data['can_raise_funding'] || $user->_data['can_create_ads'] || $user->_data['can_create_pages'] || $user->_data['can_create_groups'] || $user->_data['can_create_mibikisi'] || $user->_data['can_create_events']}
                            <!-- add -->
                            <li class="d-none d-xxl-block dropdown">
                              ...
                              <div class="dropdown-menu dropdown-menu-end">
                                ...
                                {if $user->_data['can_create_mibikisi']}
                                  <div class="dropdown-item pointer" data-toggle="modal" data-url="modules/add.php?type=mobikisi">
                                    {include file='__svg_icons.tpl' icon="mibikisi" class="main-icon mr10" width="24px" height="24px"}
                                    {__("Create Mobikisi")}
                                  </div>
                                {/if}
