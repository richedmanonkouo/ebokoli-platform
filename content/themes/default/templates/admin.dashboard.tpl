   ...
   <div class="col-sm-4">
        <div class="stat-panel bg-gradient-primary">
          <div class="stat-cell narrow">
            ...
            <span class="text-xxlg">{$insights['mibikisi']}</span><br>
            <span class="text-lg">{__("Mibikisi")}</span><br>
            <a href="{$system['system_url']}/{$control_panel['url']}/mibikisi">{__("Manage Mibikisi")}</a>
          </div>
        </div>
      </div>
      <div class="col-sm-4">
