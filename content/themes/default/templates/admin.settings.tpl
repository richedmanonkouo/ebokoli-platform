      ...
      <div class="tab-pane" id="SEO">
        <form class="js_ajax-forms" data-url="admin/settings.php?edit=seo">
          <div class="card-body">
            ...
            <div class="row form-group">
              <label class="col-md-3 form-label">
                {__("Mibikisi Description")}
              </label>
              <div class="col-md-9">
                <textarea class="form-control" name="system_description_mibikisi" rows="3">{$system['system_description_mibikisi']}</textarea>
                <div class="form-text">
                  {__("Description of your mibikisi module")}
                </div>
              </div>
            </div>
        ...
        <form class="js_ajax-forms" data-url="admin/settings.php?edit=modules">
          <div class="card-body">
            ...
            <div class="form-table-row">
              ...
              <div>
                <div class="form-label h6">{__("Reviews")}</div>
                <div class="form-text d-none d-sm-block">{__("Turn the pages reviews On and Off")}</div>
              </div>
              <div class="text-end">
                <label class="switch" for="reviews_enabled">
                  <input type="checkbox" name="reviews_enabled" id="reviews_enabled" {if $system['reviews_enabled']}checked{/if}>
                  <span class="slider round"></span>
                </label>
              </div>
            </div>
            ...
            <div class="form-table-row">
              ...
              <div>
                <div class="form-label h6">{__("Review Replacement")}</div>
              ...
              <div class="text-end">
                <label class="switch" for="reviews_replacement_enabled">
                  <input type="checkbox" name="reviews_replacement_enabled" id="reviews_replacement_enabled" {if $system['reviews_replacement_enabled']}checked{/if}>
                  <span class="slider round"></span>
                </label>
              </div>
            </div>
            ...
            <div class="form-table-row">
              <div class="avatar">
                {include file='__svg_icons.tpl' icon="mibikisi" class="main-icon" width="40px" height="40px"}
              </div>
              <div>
                <div class="form-label h6">{__("Mibikisi")}</div>
                <div class="form-text d-none d-sm-block">{__("Turn the Mibikisi On and Off")}</div>
              </div>
              <div class="text-end">
                <label class="switch" for="mibikisi_enabled">
                  <input type="checkbox" name="mibikisi_enabled" id="mibikisi_enabled" {if $system['mibikisi_enabled']}checked{/if}>
                  <span class="slider round"></span>
                </label>
              </div>
            </div>
