    ...
    <div class="col-12 sg-offcanvas-mainbar">
      ...
      <div class="profile-header">
            ...
            <div class="profile-cover-buttons">
              <div class="profile-cover-change">
                ...
                <div class="dropdown-menu action-dropdown-menu">
                  ...
                  <!-- upload -->
                  <!-- select -->
                  <div class="dropdown-item pointer" data-toggle="modal" data-url="users/photos.php?filter=cover&type=mobikisi&id={$group['group_id']}">
                    <div class="action">
          ...
          {if $group['i_admin']}
            ...
            <div class="profile-avatar-change">
              ...
              <div class="dropdown-menu action-dropdown-menu">
                ...
                <!-- upload -->
                <!-- select -->
                <div class="dropdown-item pointer" data-toggle="modal" data-url="users/photos.php?filter=avatar&type=mobikisi&id={$group['group_id']}">
                  <div class="action">
                    {include file='__svg_icons.tpl' icon="photos" class="main-icon mr10" width="20px" height="20px"}
                    {__("Select Photo")}
                  </div>
        ...
        <div class="profile-name-wrapper">
          <a href="{$system['system_url']}/mibikisi/{$group['group_name']}">{$group['group_title']}</a>
          {if $group['group_privacy'] == "public"}
            <i data-bs-toggle="tooltip" title='{__("Public Mobikisi")}' class="fa fa-globe fa-fw privacy-badge"></i>
          {elseif $group['group_privacy'] == "closed"}
            <i data-bs-toggle="tooltip" title='{__("Closed Mobikisi")}' class="fa fa-unlock-alt fa-fw privacy-badge"></i>
          {elseif $group['group_privacy'] == "secret"}
            <i data-bs-toggle="tooltip" title='{__("Secret Mobikisi")}' class="fa fa-lock fa-fw privacy-badge"></i>
          {/if}
        </div>
        <!-- profile-name -->
            ...
            <div class="dropdown-menu dropdown-menu-end action-dropdown-menu">
              ...
              {if $user->_logged_in && !$group['i_admin']}
                ...
                {if $user->_is_admin}
                  ...
                  <a class="dropdown-item" href="{$system['system_url']}/admincp/mibikisi/edit_group/{$group['group_id']}">
                    {include file='__svg_icons.tpl' icon="edit_profile" class="main-icon mr10" width="20px" height="20px"}
                    {__("Edit in Admin Panel")}
                  </a>
                {elseif $user->_is_moderator}
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item" href="{$system['system_url']}/modcp/mibikisi/edit_group/{$group['group_id']}">
                    {include file='__svg_icons.tpl' icon="edit_profile" class="main-icon mr10" width="20px" height="20px"}
      ...
      <div class="profile-tabs-wrapper d-flex justify-content-evenly">
        {if $group['group_privacy'] == "closed" && $group['i_joined'] != "approved" && !$group['i_admin'] && !$user->_is_admin && !$user->_is_moderator}
          <a href="{$system['system_url']}/mibikisi/{$group['group_name']}">
        ...
        {else}
          <a href="{$system['system_url']}/mibikisi/{$group['group_name']}" {if $view == ""}class="active" {/if}>
          ...
          <a href="{$system['system_url']}/mibikisi/{$group['group_name']}/photos" {if $view == "photos" || $view == "albums" || $view == "album"}class="active" {/if}>
          ...
          {if $system['videos_enabled']}
            <a href="{$system['system_url']}/mibikisi/{$group['group_name']}/videos" {if $view == "videos"}class="active" {/if}>
          ...
          {/if}
          <a href="{$system['system_url']}/mibikisi/{$group['group_name']}/members" {if $view == "members" || $view == "invites"}class="active" {/if}>
          ...
          {if $group['i_admin']}
            <a href="{$system['system_url']}/mibikisi/{$group['group_name']}/settings" {if $view == "settings"}class="active" {/if}>
          ...
          <div class="{if $group['chatbox_enabled']}col-lg-3 order-3 order-lg-1{else}col-lg-4 order-2 order-lg-1{/if}">
                ...
                <ul class="about-list">
                  ...
                  <li>
                    <div class="about-list-item">
                      ...
                      <a href="{$system['system_url']}/mibikisi/{$group['group_name']}/members">{$group['group_members']} {__("members")}</a>
                    </div>
                  </li>
                  <!-- members -->
                  <!-- posts -->
            ...
            {if $group['subscribers_count'] > 0}
              <div class="card">
                <div class="card-header bg-transparent">
                  {include file='__svg_icons.tpl' icon="friends" class="main-icon mr5" width="24px" height="24px"}
                  <strong><a href="{$system['system_url']}/mibikisi/{$group['group_name']}/subscribers">{__("Subscribers")}</a></strong>
            ...
            {if $group['i_joined'] == "approved" && $group['invites']}
              <div class="card">
                <div class="card-header bg-transparent">
                  <div class="float-end">
                    <small><a href="{$system['system_url']}/mibikisi/{$group['group_name']}/invites">{__("See All")}</a></small>
                  </div>
                  {include file='__svg_icons.tpl' icon="friends" class="main-icon mr5" width="24px" height="24px"}
                  <strong><a href="{$system['system_url']}/mibikisi/{$group['group_name']}/invites">{__("Invite Friends")}</a></strong>
                </div>
                <div class="card-body">
                  <ul>
            ...
            {if $get == "posts_group"}
              ...
              {if $group['i_admin'] && $group['total_requests'] > 0}
                <div class="alert alert-light">
                  ...
                  <div class="text align-middle">
                    <a href="{$system['system_url']}/mibikisi/{$group['group_name']}/settings/requests" class="alert-link">
        ...
        {elseif $view == "photos"}
          ...
          <div class="col-12">
            {if $group['needs_subscription']}
              {include file='_need_subscription.tpl' node_type='mobikisi' node_id=$group['group_id'] price=$group['group_monetization_min_price']}
            {else}
              <div class="card panel-photos">
                <div class="card-header with-icon with-nav">
                  ...
                  <ul class="nav nav-tabs">
                    <li class="nav-item">
                      <a class="nav-link active" href="{$system['system_url']}/mibikisi/{$group['group_name']}/photos">{__("Photos")}</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="{$system['system_url']}/mibikisi/{$group['group_name']}/albums">{__("Albums")}</a>
                    </li>
                  </ul>
                  <!-- panel nav -->
                </div>
            ...
            {else}
              <div class="card">
                <div class="card-header with-icon with-nav">
                  ...
                  <ul class="nav nav-tabs">
                    <li class="nav-item">
                      <a class="nav-link" href="{$system['system_url']}/mibikisi/{$group['group_name']}/photos">{__("Photos")}</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link active" href="{$system['system_url']}/mibikisi/{$group['group_name']}/albums">{__("Albums")}</a>
                    </li>
                  </ul>
                  <!-- panel nav -->
                </div>
            ...
            {else}
              <div class="card panel-photos">
                <div class="card-header with-icon with-nav">
                  <!-- back to albums -->
                  <div class="float-end">
                    <a href="{$system['system_url']}/mibikisi/{$group['group_name']}/albums" class="btn btn-md btn-light">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header with-icon with-nav">
                ...
                <ul class="nav nav-tabs">
                  <li class="nav-item">
                    <a class="nav-link active" href="{$system['system_url']}/mibikisi/{$group['group_name']}/members">
                      {__("Members")}
                  ...
                  {if $group['has_subscriptions_plans']}
                    <li class="nav-item">
                      <a class="nav-link" href="{$system['system_url']}/mibikisi/{$group['group_name']}/subscribers">{__("Subscribers")}</a>
                    </li>
                  {/if}
                  {if $group['i_joined'] == "approved"}
                    <li class="nav-item">
                      <a class="nav-link" href="{$system['system_url']}/mibikisi/{$group['group_name']}/invites">{__("Invites")}</a>
                    </li>
                  {/if}
                </ul>
                <!-- panel nav -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header with-icon with-nav">
                ...
                <ul class="nav nav-tabs">
                  <li class="nav-item">
                    <a class="nav-link" href="{$system['system_url']}/mibikisi/{$group['group_name']}/members">{__("Members")}</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link active" href="{$system['system_url']}/mibikisi/{$group['group_name']}/subscribers">
                      {__("Subscribers")}
            ...
            <div class="card">
              <div class="card-header with-icon with-nav">
                ...
                <ul class="nav nav-tabs">
                  ...
                  {/if}
                  <li class="nav-item">
                    <a class="nav-link active" href="{$system['system_url']}/mibikisi/{$group['group_name']}/invites">
                      {__("Invites")}
                    </a>
                  </li>
                </ul>
              ...
              <div class="card-body with-nav">
                <ul class="side-nav">
                  <li {if $sub_view == ""}class="active" {/if}>
                    <a href="{$system['system_url']}/mibikisi/{$group['group_name']}/settings">
                  ...
                  {if $group['group_privacy'] != "public"}
                    <li {if $sub_view == "requests"}class="active" {/if}>
                      <a href="{$system['system_url']}/mibikisi/{$group['group_name']}/settings/requests">
                        {include file='__svg_icons.tpl' icon="friends" class="main-icon mr10" width="24px" height="24px"}
                        {__("Join Requests")}
                      </a>
                    </li>
                  ...
                  <li {if $sub_view == "members"}class="active" {/if}>
                    <a href="{$system['system_url']}/mibikisi/{$group['group_name']}/settings/members">
                      {include file='__svg_icons.tpl' icon="friends" class="main-icon mr10" width="24px" height="24px"}
                      {__("Members")}
                    </a>
                  </li>
                  {if $user->_data['can_monetize_content']}
                    <li {if $sub_view == "monetization"}class="active" {/if}>
                      <a href="{$system['system_url']}/mibikisi/{$group['group_name']}/settings/monetization">
                  ...
                  {if $user->_data['user_id'] == $group['group_admin']}
                    <li {if $sub_view == "delete"}class="active" {/if}>
                      <a href="{$system['system_url']}/mibikisi/{$group['group_name']}/settings/delete">
          ...
          <div class="col-lg-9">
            <div class="card">
              {if $sub_view == ""}
                ...
                <form class="js_ajax-forms" data-url="modules/create.php?type=mobikisi&do=edit&edit=settings&id={$group['group_id']}">
                  <div class="card-body">
                    <div class="form-group">
                      <label class="form-label" for="title">{__("Name Your Mobikisi")}</label>
                      <input type="text" class="form-control" name="title" id="title" placeholder='{__("Name of your mobikisi")}' value="{$group['group_title']}">
                    </div>
                    <div class="form-group">
                      <label class="form-label" for="username">{__("Mobikisi Username")}</label>
                      <div class="input-group">
                        <span class="input-group-text d-none d-sm-block">{$system['system_url']}/mibikisi/</span>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-select" name="privacy">
                        <option {if $group['group_privacy'] == "public"}selected{/if} value="public">{__("Public Mobikisi")}</option>
                        <option {if $group['group_privacy'] == "closed"}selected{/if} value="closed">{__("Closed Mobikisi")}</option>
                        <option {if $group['group_privacy'] == "secret"}selected{/if} value="secret">{__("Secret Mobikisi")}</option>
                      </select>
                      <div class="form-text">
              ...
              {elseif $sub_view == "monetization"}
                ...
                <div class="card-body">
                  ...
                  <div class="pl-md-4">
                    <form class="js_ajax-forms" data-url="modules/create.php?type=mobikisi&do=edit&edit=monetization&id={$group['group_id']}">
                      <div class="form-table-row">
                        <div class="avatar">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <div class="payment-plans">
                            ...
                            {/foreach}
                            <div data-toggle="modal" data-url="monetization/controller.php?do=add&node_id={$group['group_id']}&node_type=mobikisi" class="payment-plan new">{__("Add new plan")} </div>
                          </div>
                        </div>
                      </div>
