      ...
      <div class="card mb15">
        ...
        <div class="card-body with-nav">
          <ul class="side-nav">
            ...
            <!-- Mibikisi -->
            <li {if $view == "mibikisi"}class="active" {/if}>
              <a href="#mibikisi" data-bs-toggle="collapse" {if $view == "mibikisi"}aria-expanded="true" {/if}>
                <i class="fa fa-money-bill fa-lg fa-fw mr10" style="color: #F44336"></i>{__("Mibikisi")}
              </a>
              <div class='collapse {if $view == "mibikisi"}show{/if}' id="mibikisi">
                <ul>
                  <li {if $view == "mibikisi" && $sub_view == ""}class="active" {/if}>
                    <a href="{$system['system_url']}/{$control_panel['url']}/mibikisi">
                      {__("List Mibikisi")}
                    </a>
                  </li>
                  <li {if $view == "mibikisi" && $sub_view == "categories"}class="active" {/if}>
                    <a href="{$system['system_url']}/{$control_panel['url']}/mibikisi/categories">
                      {__("List Categories")}
                    </a>
                  </li>
                </ul>
