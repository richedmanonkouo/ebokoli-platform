          ...
          <ul class="landing-slides">
            ...
            <li class="landing-slide-container">
              <div class="landing-slide">
                <img src="{$system['system_url']}/content/themes/{$system['theme']}/images/landing/slide_1.jpg" />
              </div>
              <div class="nav">
            ...
            <li class="landing-slide-container">
              <div class="landing-slide">
                <img src="{$system['system_url']}/content/themes/{$system['theme']}/images/landing/slide_2.jpg" />
              </div>
              <div class="nav">
            ...
            <li class="landing-slide-container">
              <div class="landing-slide">
                <img src="{$system['system_url']}/content/themes/{$system['theme']}/images/landing/slide_3.jpg" />
              </div>
              <div class="nav">
