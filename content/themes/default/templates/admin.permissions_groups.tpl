        ...
        <div class="pl-md-4">
          ...
          <div class="form-table-row">
            ...
            <div>
              ...
              <div class="form-text d-none d-sm-block">{__("Can Create Mibikisi")}</div>
            </div>
            <div class="text-end">
              <label class="switch" for="mibikisi_permission">
                <input type="checkbox" name="mibikisi_permission" id="mibikisi_permission">
                <span class="slider round"></span>
              </label>
            </div>
          </div>
      ...
      <div class="card-body">
        ...
        <div class="pl-md-4">
          ...
          <div class="form-table-row">
            ...
            <div class="text-end">
              <label class="switch" for="mibikisi_permission">
                <input type="checkbox" name="mibikisi_permission" id="mibikisi_permission" {if $data['mibikisi_permission']}checked{/if}>
                <span class="slider round"></span>
              </label>
            </div>
          </div>
