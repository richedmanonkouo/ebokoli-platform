<?php
/* Smarty version 4.3.4, created on 2025-04-23 04:37:47
  from '/home/u994747101/domains/ebokoli.com/public_html/content/themes/default/templates/admin.mibikisi.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_68086e9bcb2391_59801012',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b780f7d945dc27eeb390258cd639db331a7d9741' => 
    array (
      0 => '/home/u994747101/domains/ebokoli.com/public_html/content/themes/default/templates/admin.mibikisi.tpl',
      1 => 1744047699,
      2 => 'file',
    ),
  ),
...
function content_68086e9bcb2391_59801012 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="card">
...
/mibikisi" class="btn btn-md btn-light">
          <i class="fa fa-arrow-circle-left mr5"></i><?php echo __("Go Back");?>

        </a>
      </div>
    <?php } elseif ($_smarty_tpl->tpl_vars['sub_view']->value == "edit_mobikisi") {?>
      <div class="float-end">
        <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/<?php echo $_smarty_tpl->tpl_vars['control_panel']->value['url'];?>
/mibikisi" class="btn btn-md btn-light">
...
/mibikisi/<?php echo $_smarty_tpl->tpl_vars['data']->value['group_name'];?>
" class="btn btn-md btn-info">
          <i class="fa fa-eye"></i><span class="ml5 d-none d-lg-inline-block"><?php echo __("View Mobikisi");?>
</span>
        </a>
      </div>
    <?php } elseif ($_smarty_tpl->tpl_vars['sub_view']->value == "categories") {?>
      <div class="float-end">
        <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/<?php echo $_smarty_tpl->tpl_vars['control_panel']->value['url'];?>
/mibikisi/add_category" class="btn btn-md btn-primary">
    ...
    <?php } elseif ($_smarty_tpl->tpl_vars['sub_view']->value == "add_category" || $_smarty_tpl->tpl_vars['sub_view']->value == "edit_category") {?>
      <div class="float-end">
        <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/<?php echo $_smarty_tpl->tpl_vars['control_panel']->value['url'];?>
/mibikisi/categories" class="btn btn-md btn-light">
          <i class="fa fa-arrow-circle-left"></i><span class="ml5 d-none d-lg-inline-block"><?php echo __("Go Back");?>
</span>
        </a>
      </div>
    <?php }?>
    <i class="fa fa-users mr10"></i><?php echo __("Mibikisi");?>

    <?php if ($_smarty_tpl->tpl_vars['sub_view']->value == "find") {?> &rsaquo; <?php echo __("Find");
}?>
    <?php if ($_smarty_tpl->tpl_vars['sub_view']->value == "edit_mobikisi") {?> &rsaquo; <?php echo $_smarty_tpl->tpl_vars['data']->value['group_title'];
}?>
...
/mibikisi/find" method="get">
        ...
        <div class="form-text small">
          <?php echo __('Search by Mobikisi Web Address or Title');?>
...
?>
                <tr>
                  <td>
                    <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/mibikisi/<?php echo $_smarty_tpl->tpl_vars['row']->value['group_name'];?>
...
/<?php echo $_smarty_tpl->tpl_vars['control_panel']->value['url'];?>
/mibikisi/edit_mobikisi/<?php echo $_smarty_tpl->tpl_vars['row']->value['group_id'];?>
...
">
      ...
      <div class="tab-content">
        ...
        <div class="tab-pane active" id="group_settings">
          <form class="js_ajax-forms" data-url="admin/mibikisi.php?do=edit_mobikisi&edit=settings&id=<?php echo $_smarty_tpl->tpl_vars['data']->value['group_id'];?>
">
            ...
            <div class="row form-group">
              ...
              <div class="col-md-9">
                <select class="form-select" name="privacy">
                  <option <?php if ($_smarty_tpl->tpl_vars['data']->value['group_privacy'] == "public") {?>selected<?php }?> value="public"><?php echo __("Public Mobikisi");?>
</option>
                  <option <?php if ($_smarty_tpl->tpl_vars['data']->value['group_privacy'] == "closed") {?>selected<?php }?> value="closed"><?php echo __("Closed Mobikisi");?>
</option>
                  <option <?php if ($_smarty_tpl->tpl_vars['data']->value['group_privacy'] == "secret") {?>selected<?php }?> value="secret"><?php echo __("Secret Mobikisi");?>
</option>
                </select>
                <div class="form-text">
...
?>
              ...
              <div>
                ...
                <div class="form-text d-none d-sm-block"><?php echo __("Enable chat box for this mobikisi");?>
</div>
              </div>
              <div class="text-end">
            ...
            <div class="form-table-row">
              <div>
                ...
                <div class="form-text d-none d-sm-block">
                  <?php echo __("All posts must be approved by a mobikisi admin");?>
<br>
...
/<?php echo $_smarty_tpl->tpl_vars['control_panel']->value['url'];?>
/mibikisi">
                <i class="fa fa-trash-alt mr5"></i><?php echo __("Delete Mobikisi");?>
        ...
        <div class="tab-pane" id="group_monetization">
          <?php if ($_smarty_tpl->tpl_vars['data']->value['can_monetize_content']) {?>
            <form class="js_ajax-forms" data-url="admin/mibikisi.php?do=edit_mobikisi&edit=monetization&id=<?php echo $_smarty_tpl->tpl_vars['data']->value['group_id'];?>
">
              <div class="form-table-row">
                <div class="avatar">
...
&node_type=mobikisi" class="payment-plan new"><?php echo __("Add new plan");?>
 </div>
                  </div>
                </div>
              </div>
...
$_smarty_tpl->tpl_vars['row']->do_else = false;
?>
                <?php $_smarty_tpl->_subTemplateRender('file:__categories.recursive_rows.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('_url'=>"mibikisi",'_handle'=>"group_category"), 0, true);
?>
              <?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
  ...
  <?php } elseif ($_smarty_tpl->tpl_vars['sub_view']->value == "add_category") {?>
    ...
    <form class="js_ajax-forms" data-url="admin/mibikisi.php?do=add_category">
      <div class="card-body">
        <div class="row form-group">
          <label class="col-md-3 form-label">
            <?php echo __("Name");?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
  ...
  <?php } elseif ($_smarty_tpl->tpl_vars['sub_view']->value == "edit_category") {?>
    ...
    <form class="js_ajax-forms" data-url="admin/mibikisi.php?do=edit_category&id=<?php echo $_smarty_tpl->tpl_vars['data']->value['category_id'];?>
">
      <div class="card-body">
        <div class="row form-group">
          <label class="col-md-3 form-label">
