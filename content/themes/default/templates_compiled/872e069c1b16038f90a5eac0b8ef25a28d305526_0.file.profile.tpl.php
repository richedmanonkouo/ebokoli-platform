<?php
/* Smarty version 4.3.4, created on 2025-04-29 15:36:56
  from '/home/u994747101/domains/ebokoli.com/public_html/content/themes/default/templates/profile.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_6810f21805a4e9_90957113',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '872e069c1b16038f90a5eac0b8ef25a28d305526' => 
    array (
      0 => '/home/u994747101/domains/ebokoli.com/public_html/content/themes/default/templates/profile.tpl',
      1 => 1745941003,
      2 => 'file',
    ),
  ),
...
function content_6810f21805a4e9_90957113 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'/home/u994747101/domains/ebokoli.com/public_html/vendor/smarty/smarty/libs/plugins/modifier.date_format.php','function'=>'smarty_modifier_date_format',),));
...
?>
        ...
        <?php }?>
        <?php if ($_smarty_tpl->tpl_vars['system']->value['mibikisi_enabled']) {?>
          <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/<?php echo $_smarty_tpl->tpl_vars['profile']->value['user_name'];?>
/mibikisi" <?php if ($_smarty_tpl->tpl_vars['view']->value == "mibikisi") {?>class="active" <?php }?>>
            <?php $_smarty_tpl->_subTemplateRender('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"group",'class'=>"main-icon mr5",'width'=>"24px",'height'=>"24px"), 0, true);
?>
            <span class="ml5 d-none d-xxl-inline-block"><?php echo __("Mibikisi");?>
</span>
          </a>
        <?php }?>        
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
            ...
            <!-- mibikisi -->
            <?php if ($_smarty_tpl->tpl_vars['system']->value['mibikisi_enabled'] && count($_smarty_tpl->tpl_vars['profile']->value['mibikisi']) > 0) {?>
              <div class="card">
                <div class="card-header bg-transparent">
                  <?php $_smarty_tpl->_subTemplateRender('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"group",'class'=>"main-icon mr5",'width'=>"24px",'height'=>"24px"), 0, true);
?>
                  <strong><a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/<?php echo $_smarty_tpl->tpl_vars['profile']->value['user_name'];?>
/mibikisi"><?php echo __("Mibikisi");?>
</a></strong>
                </div>
                <div class="card-body ptb10 plr10">
                  <div class="row">
                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['profile']->value['mibikisi'], '_group');
$_smarty_tpl->tpl_vars['_group']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['_group']->value) {
$_smarty_tpl->tpl_vars['_group']->do_else = false;
?>
                      <div class="col-3 col-lg-4">
                        <div class="circled-user-box">
                          <a class="user-box" href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/mibikisi/<?php echo $_smarty_tpl->tpl_vars['_group']->value['group_name'];?>
">
                            <img alt="<?php echo $_smarty_tpl->tpl_vars['_group']->value['group_title'];?>
" src="<?php echo $_smarty_tpl->tpl_vars['_group']->value['group_picture'];?>
" />
...
?>
        ...
        <?php } elseif ($_smarty_tpl->tpl_vars['view']->value == "mibikisi") {?>
          <!-- mibikisi -->
          <div class="col-12">
            <div class="card">
              <div class="card-header with-icon">
                <!-- panel title -->
                <?php $_smarty_tpl->_subTemplateRender('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"group",'class'=>"main-icon mr10",'width'=>"24px",'height'=>"24px"), 0, true);
?>
                <?php echo __("Mibikisi");?>

                <!-- panel title -->
              </div>
              <div class="card-body">
                <?php if ($_smarty_tpl->tpl_vars['profile']->value['user_id'] == $_smarty_tpl->tpl_vars['user']->value->_data['user_id'] || $_smarty_tpl->tpl_vars['profile']->value['user_privacy_mibikisi'] == "public" || ($_smarty_tpl->tpl_vars['profile']->value['user_privacy_mibikisi'] == "friends" && $_smarty_tpl->tpl_vars['profile']->value['we_friends'])) {?>
                  <?php if (count($_smarty_tpl->tpl_vars['profile']->value['mibikisi']) > 0) {?>
                    <ul class="row">
                      <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['profile']->value['mibikisi'], '_group');
$_smarty_tpl->tpl_vars['_group']->do_else = true;
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                    ...
                    <?php if (count($_smarty_tpl->tpl_vars['profile']->value['mibikisi']) >= $_smarty_tpl->tpl_vars['system']->value['max_results_even']) {?>
                      <!-- see-more -->
                      <div class="alert alert-post see-more js_see-more" data-get="profile_groups" data-uid="<?php echo $_smarty_tpl->tpl_vars['profile']->value['user_id'];?>
">
                        <span><?php echo __("See More");?>
